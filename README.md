...
│   │   ├── move_ordering.hpp         # SEE、Killer、Counter 与 History 排序
...
排列的 History 安静着，以及 SEE 为负的亏损吃子。MVV-LVA 和 SEE 使用手工
评估器统一提供的基础子力价值；安静着造成 Beta 截断时会更新 Killer、Counter
和 History，并对同节点先前失败的安静着降低历史分。
...
- [x] 安全将军着优先
- [x] 第一、第二 Killer Move
- [x] Counter Move 与有界 History Heuristic
- [x] 静态搜索和被将时的应将搜索
- [x] 迭代加深
- [x] 固定容量置换表
