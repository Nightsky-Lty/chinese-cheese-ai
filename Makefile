...
ENGINE_SOURCE := engine/src/position.cpp engine/src/game_history.cpp engine/src/cycle_adjudicator.cpp engine/src/evaluation.cpp engine/src/halfka.cpp engine/src/move_ordering.cpp engine/src/nnue.cpp engine/src/search.cpp engine/src/transposition_table.cpp
